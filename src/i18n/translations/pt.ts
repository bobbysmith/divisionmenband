...
const pt: TranslationStrings = {
  ...
  'nav.bio': 'Biografia',
  'nav.videos': 'V\u00EDdeos',
  'nav.reviews': 'Imprensa',
  'nav.social': 'Contacto',

  'hero.label': 'Motor Music',
  'hero.pressKit': 'Baixar kit de imprensa',
  ...
  'bio.p4':
    'Caroline Rippy Portillo nasceu em San Antonio, Texas. De 2007 a 2012, tocou baixo para Tito & Tarantula. J. Spencer Portillo \u00E9 natural de Los Angeles, Calif\u00F3rnia, mas cresceu em El Paso, Texas. As suas ra\u00EDzes em El Paso exercem uma grande influ\u00EAncia nas letras que apresentam retratos atmosf\u00E9ricos de amor, vida e morte numa cidade fronteiri\u00E7a.',

  'videos.heading': 'V\u00EDdeos',

  'reviews.heading': 'Imprensa',

  'social.heading': 'Contacto',

  'footer.pressKit': 'Kit de imprensa oficial',
