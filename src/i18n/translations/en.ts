...
const en: TranslationStrings = {
  ...
  'hero.pressKit': 'Download Press Kit',
  ...
  'bio.p4':
    'Caroline Rippy Portillo was born in San Antonio, Texas. From 2007 until 2012, she played bass guitar for Tito & Tarantula. J. Spencer Portillo hails from Los Angeles, California but was raised in El Paso, Texas. His El Paso roots offer a huge influence on the lyrics which present atmospheric portraits of love, life and death in a border town.',

  'videos.heading': 'Videos',

  'reviews.heading': 'Press',

  'social.heading': 'Connect',

  'footer.pressKit': 'Official Press Kit',
